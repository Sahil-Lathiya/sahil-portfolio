...
const FEATURED = {
  ...
  desc: `Most recommender systems are black boxes — they tell you what to buy, not why. I built XAI Recommender to fix that: every recommendation comes with a SHAP-grounded explanation and a plain-English summary generated by GPT-4o-mini. The goal was production-grade explainability, not a research demo — 24/7 uptime, 4-layer caching, sub-150ms latency, and under £10/month in cloud costs.`,
  bullets: [
